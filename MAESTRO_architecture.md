...
- Each lane declares public acceptance criteria. An acceptance item is either a bare criterion string or `{criterion, gating, observation_seam, decided_by, refusal_required}`.
